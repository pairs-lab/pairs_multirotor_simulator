...
def generate_launch_description():
    ...
    pkg_name = "pairs_multirotor_simulator"
    ...
    pairs_multirotor_simulator_configs = [
        # general configs
    ...
    pairs_multirotor_simulator_uav_configs = [
        # general configs
        pkg_share_path + '/config/multirotor_simulator.yaml',
    ...
    ld.add_action(ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                package=pkg_name,
                plugin='pairs_multirotor_simulator::MultirotorSimulator',
                namespace='',
                name='multirotor_simulator',
                parameters=[
                    {'simulator_configs': pairs_multirotor_simulator_configs},
                    {'uav_configs': pairs_multirotor_simulator_uav_configs},
                    {'custom_config': custom_config},
                ],
